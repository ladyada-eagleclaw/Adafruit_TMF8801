...
#define TMF8801_RESULT_RELIABILITY_LEVELS 64   ///< Number of reliability levels
#define TMF8801_RESULT_RELIABILITY_HIGH_MIN 32 ///< Example high-label threshold
 ...
 */
typedef enum {
  TMF8801_MEASUREMENT_NOT_INTERRUPTED = 0,   ///< Measurement completed normally
  TMF8801_MEASUREMENT_STATUS_RESERVED_1 = 1, ///< Reserved
  TMF8801_MEASUREMENT_INTERRUPTED_BY_GPIO = 2, ///< Delayed by GPIO input
  TMF8801_MEASUREMENT_STATUS_RESERVED_3 = 3,   ///< Reserved
} tmf8801_measurement_status_t;
...
typedef struct {
  ...
  tmf8801_measurement_status_t status; ///< Measurement completion status
